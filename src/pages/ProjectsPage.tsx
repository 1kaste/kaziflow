...
import { Project, Task, ProjectURL, Page, UserCategory } from '../types';
import ProgressBar from '../components/ProgressBar';
import { useAppContext } from '../context/AppContext';
import { Icon, TrashIcon, LinkIcon, ClipboardIcon, PlusCircleIcon, CheckCircleIcon, ArrowLeftIcon, ClientsIcon } from '../constants';
...
const ProjectDetailPage: React.FC<{
    ...
    const { clients, setActivePage, setInitialSelectedClientId } = useAppContext();
                        ...
                        <div>
                           <div className="flex items-center gap-2 mb-4">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button onClick={handleAddUrl} className="p-2 bg-brand-teal text-white rounded-md hover:bg-opacity-90 transition-colors">+</button>
                            </div>
                        </div>
...
const ProjectsPage: React.FC = () => {
    const { user, projects, setProjects, initialSelectedProjectId, setInitialSelectedProjectId, triggerProjectCreationForClientId, setTriggerProjectCreationForClientId } = useAppContext();
    ...
    const handleUpdateProject = useCallback((updatedProject: Project) => {
        ...
        updatedProject.completion = totalTasks > 0 ? Math.round((completedTasks / totalTasks) * 100) : 0;
