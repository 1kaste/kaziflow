        ...
        <div className={`flex flex-col items-center justify-center min-h-screen transition-colors duration-300 ${theme === 'dark' ? 'bg-dark-primary text-white' : 'bg-light-primary text-black'}`}>
            ...
            <div className="w-full max-w-md p-8 space-y-8 bg-light-secondary dark:bg-dark-secondary rounded-2xl shadow-2xl">
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <button
                        type="submit"
                        className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-brand-teal hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-teal transition-all"
                    >
                        Sign in
                    </button>
                </form>
